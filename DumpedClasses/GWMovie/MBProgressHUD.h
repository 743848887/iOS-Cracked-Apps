...
@class NSDate, NSNumber, NSString, NSTimer, UIColor, UIFont, UILabel;
...
+ (id)showNormalHubString:(id)arg1 toView:(id)arg2;
...
@property(copy, nonatomic) NSNumber *forceLabelTextWidth; // @synthesize forceLabelTextWidth=_forceLabelTextWidth;
@property _Bool isEnableClickBack; // @synthesize isEnableClickBack=_isEnableClickBack;
...
- (id)loadWidthLabel:(id)arg1;
- (id)loadLabel:(id)arg1;
- (void)setCustomViewAddSuccess:(id)arg1 detailsLabel:(id)arg2;
- (void)setCustomViewSuccess:(id)arg1;
- (void)setCustomViewretry:(id)arg1;
- (void)setCustomViewCheckMark:(id)arg1;

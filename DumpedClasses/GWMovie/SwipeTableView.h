...
{
    _Bool _banCurrentItemViewOffset;
...
@property(nonatomic) _Bool banCurrentItemViewOffset; // @synthesize banCurrentItemViewOffset=_banCurrentItemViewOffset;
...
@property(retain, nonatomic) UIView *swipeTopLogoView; // @synthesize swipeTopLogoView=_swipeTopLogoView;

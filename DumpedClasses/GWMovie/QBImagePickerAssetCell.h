...
#import "QBImagePickerAssetViewDelegate-Protocol.h"
...
@interface QBImagePickerAssetCell : UITableViewCell <QBImagePickerAssetViewDelegate>
{
    ...
    id <QBImagePickerAssetCellDelegate> _delegate;
    NSArray *_assets;
...
@property(nonatomic) __weak id <QBImagePickerAssetCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;

...
@interface GWAppNotificationMsgViewController : GWBaseViewController <UITableViewDelegate, UITableViewDataSource>
{
    _Bool _isLoading;
    UITableView *_tableView;
    NSMutableArray *_dataArr;
    GWGWFindMessageListByTypeProvider *_appNotMsgProvider;
...
@property(retain, nonatomic) GWGWFindMessageListByTypeProvider *appNotMsgProvider; // @synthesize appNotMsgProvider=_appNotMsgProvider;

...
@interface QLJCEMyCommentListResponse : JceObjectV2
{
    _Bool jcev2_p_3_o_hasNextPage;
    int jcev2_p_0_r_errCode;
    NSArray *jcev2_p_1_o_itemList__b0x9i_VOQLJCEMyCommentItem;
...
@property(retain, nonatomic, getter=jce_itemList, setter=setJce_itemList:) NSArray *jcev2_p_1_o_itemList__b0x9i_VOQLJCEMyCommentItem; // @synthesize jcev2_p_1_o_itemList__b0x9i_VOQLJCEMyCommentItem;

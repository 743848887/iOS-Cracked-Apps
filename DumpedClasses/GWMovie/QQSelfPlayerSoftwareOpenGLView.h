...
- (void)lockGLActive;
- (void)updateVertices;
- (void)renderInternalFrameWithNoPadding:(char *)arg1 framewidth:(int)arg2 frameheight:(int)arg3 dstwidth:(int)arg4 dstheight:(int)arg5 viewFrame:(struct CGRect)arg6;
- (void)renderFrameWithNoPadding:(char *)arg1 framewidth:(int)arg2 frameheight:(int)arg3 dstwidth:(int)arg4 dstheight:(int)arg5 viewFrame:(struct CGRect)arg6;

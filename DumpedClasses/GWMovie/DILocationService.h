...
@interface DILocationService : NSObject <CLLocationManagerDelegate>
{
    ...
    CDStruct_2c43369c _coor;
    CDStruct_2c43369c _lastLocationCoor;
}

+ (double)distanceFromCoor:(CDStruct_c3b9c2ee)arg1 toCoor:(CDStruct_c3b9c2ee)arg2;
+ (id)sharedInstance;
...
@property(nonatomic) CDStruct_c3b9c2ee lastLocationCoor; // @synthesize lastLocationCoor=_lastLocationCoor;
@property(nonatomic) CDStruct_c3b9c2ee coor; // @synthesize coor=_coor;
- (void).cxx_destruct;

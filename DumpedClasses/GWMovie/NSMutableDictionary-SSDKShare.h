...
- (void)SSDKSetupAliPaySocialParamsByText:(id)arg1 image:(id)arg2 title:(id)arg3 url:(id)arg4 type:(unsigned long long)arg5 platformType:(unsigned long long)arg6;

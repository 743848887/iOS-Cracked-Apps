...
#import "GWTTTAttributedLabel-Protocol.h"
...
@interface GWTTTAttributedLabel : UILabel <GWTTTAttributedLabel, UIGestureRecognizerDelegate>
{
    ...
    double _linkBackgroundInsetDX;
    double _linkBackgroundInsetDY;
    ...
    NSAttributedString *_truncationTokenAttributedString;
...
@property(retain, nonatomic) NSAttributedString *truncationTokenAttributedString; // @synthesize truncationTokenAttributedString=_truncationTokenAttributedString;
...
@property(nonatomic) double linkBackgroundInsetDY; // @synthesize linkBackgroundInsetDY=_linkBackgroundInsetDY;
@property(nonatomic) double linkBackgroundInsetDX; // @synthesize linkBackgroundInsetDX=_linkBackgroundInsetDX;
...
- (void)drawEachOneLineComments:(struct __CTLine *)arg1 lineOrigion:(struct CGPoint)arg2 atContext:(struct CGContext *)arg3;

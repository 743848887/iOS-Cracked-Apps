...
@class CLLocationManager, NSArray, NSMutableArray, NSOperationQueue, NSString, QAnnotationFloor, QBaseView, QCircle, QMapAnimationContainer, QOverlayFloor, QScaleView, QUserLocation, QViewRecycler, UIImageView, UILongPressGestureRecognizer, UITapGestureRecognizer;

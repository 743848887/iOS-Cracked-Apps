...
@class MASTAdView, NSString, TADLandingViewController, TADMediaItem, TADMediaLog, TADReportDP3, TADReportMediaItemList, TADReportSingleMediaItem;

@interface TADViewController : UIViewController <MASTAdViewDelegate, TADLandingViewControllerDelegate>
{

...
@interface GWAnimatedImageView : GWImagePolicyView
{
...
- (void).cxx_destruct;
- (void)setGIFImageWithURLString:(id)arg1 placeholderImage:(id)arg2 options:(unsigned long long)arg3 progress:(CDUnknownBlockType)arg4 completed:(CDUnknownBlockType)arg5 policy:(id)arg6;

...
@class GADAutoClickProtection, GADSafeBrowsingReporter, GADStatisticDictionary, GADSwipeToViewControllerConfigurations, NSDictionary, NSMutableSet, NSString, NSURL;

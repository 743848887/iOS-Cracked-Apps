...
@protocol WKSimplePingDelegate;

@interface WKSimplePing : NSObject
{
    ...
    NSString *_hostName;
    NSData *_hostAddress;
    id <WKSimplePingDelegate> _delegate;
}
...
@property(nonatomic) __weak id <WKSimplePingDelegate> delegate; // @synthesize delegate=_delegate;

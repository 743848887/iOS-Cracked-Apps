...
@interface SubwayAuthen : CCWINetProvider
{
    int _apid;
...
+ (_Bool)isSubwayWiFiWithResponseData:(id)arg1;
...
- (void)SubwayConnectWithError:(id)arg1;
- (void)SubwayCheckSMSWithError:(id)arg1;
- (void)SubwayGetSMSCheckWithError:(id)arg1 phoneNumber:(id)arg2;
- (void)initSubwayProder:(id)arg1 partnerarg:(id)arg2 ssid:(id)arg3 apid:(int)arg4;
- (id)init;

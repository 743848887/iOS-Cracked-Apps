...
@interface HaiDianWiFiAuthen : CCWINetProvider
{
    int _apid;
    ...
    NSMutableDictionary *_loginform3;
    NSString *_ssid;
}

+ (_Bool)isHaiDianWiFiWithResponseData:(id)arg1;
@property(nonatomic) int apid; // @synthesize apid=_apid;
@property(retain, nonatomic) NSString *ssid; // @synthesize ssid=_ssid;
@property(retain, nonatomic) NSMutableDictionary *loginform3; // @synthesize loginform3=_loginform3;
...
- (void)dealloc;
- (void)HaiDianWiFiConnectWithError:(id)arg1;
- (void)HaiDianWiFiCheckSMSWithError:(id)arg1;
- (void)HaiDianWiFiGetSMSCheckWithError:(id)arg1 phoneNumber:(id)arg2;
- (void)initHaiDianWiFiProder:(id)arg1 partnerarg:(id)arg2 ssid:(id)arg3 apid:(int)arg4;
- (id)init;

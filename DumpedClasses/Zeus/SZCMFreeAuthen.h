...
@interface SZCMFreeAuthen : CCWINetProvider
{
    int _apid;
    ...
    NSMutableDictionary *_baseInfo;
    NSString *_portalHtml;
    NSString *_ssid;
}

+ (_Bool)isSZCMFreeWiFiWithResponseData:(id)arg1;
...
@property(retain, nonatomic) NSMutableDictionary *baseInfo; // @synthesize baseInfo=_baseInfo;
...
- (id)timestamp;
- (void)SZCMFreeConnectWithError:(id)arg1;
- (void)SZCMFreeCheckSMSWithError:(id)arg1;
- (void)SZCMFreeGetSMSCheckWithError:(id)arg1 phoneNumber:(id)arg2;
- (void)initSZCMFreeProder:(id)arg1 partnerarg:(id)arg2 ssid:(id)arg3 apid:(int)arg4;
- (id)init;

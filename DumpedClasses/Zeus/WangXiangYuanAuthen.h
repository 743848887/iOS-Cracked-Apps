...
@interface WangXiangYuanAuthen : CCWINetProvider
{
    int _apid;
...
+ (_Bool)isWXYWiFiWithResponseData:(id)arg1;
...
- (void)WXYConnectWithError:(id)arg1;
- (void)WXYCheckSMSWithError:(id)arg1;
- (void)WXYGetSMSCheckWithError:(id)arg1 phoneNumber:(id)arg2;
- (void)initWXYProder:(id)arg1 partnerarg:(id)arg2 ssid:(id)arg3 apid:(int)arg4;
- (id)init;

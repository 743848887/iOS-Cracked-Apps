...
@interface AircoWifiAuthen : CCWINetProvider
{
    int _apid;
    NSString *_smsUrl;
    NSString *_ssid;
...
+ (_Bool)isAircoWiFiWithResponseData:(id)arg1;
...
- (void)dealloc;
- (void)AircoWifiCheckSMSWithError:(id)arg1;
- (void)AircoWifiGetSMSWithError:(id)arg1 phoneNumber:(id)arg2;
- (void)initAircoWifiProder:(id)arg1 partnerarg:(id)arg2 ssid:(id)arg3 apid:(int)arg4;
- (id)init;

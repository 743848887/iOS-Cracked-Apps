...
@interface SZAirportAuthen : CCWINetProvider
{
    int _apid;
...
+ (_Bool)isSZAirportWiFiWithResponseData:(id)arg1;
...
- (id)timestamp;
- (void)SZAirportConnectWithError:(id)arg1;
- (void)SZAirportCheckSMSWithError:(id)arg1;
- (void)SZAirportGetSMSCheckWithError:(id)arg1 phoneNumber:(id)arg2;
- (void)initSZAirportProder:(id)arg1 partnerarg:(id)arg2 ssid:(id)arg3 apid:(int)arg4;
- (id)init;

...
@property(nonatomic) id <WifiinMemberBindDelegate> memberDelegate; // @synthesize memberDelegate=_memberDelegate;
...
@property(nonatomic) id <WifiinDelegate> wifiDelegate; // @synthesize wifiDelegate=_wifiDelegate;
...
- (void)scanWifi;
- (void)sendPersonalWifiHeartbeatNation:(id)arg1 province:(id)arg2 city:(id)arg3 ssid:(id)arg4 mac:(id)arg5 apid:(int)arg6 latitude:(float)arg7 longitude:(float)arg8 geoSupplier:(int)arg9 psk:(id)arg10;
...
- (id)getNearHotFromServer:(float)arg1 longitude:(float)arg2 wifiArray:(id)arg3;
...
- (void)updateLocalApAccount;
- (void)cancelConnect;
- (void)disConnect;
- (void)connect:(id)arg1 province:(id)arg2 city:(id)arg3 latitude:(float)arg4 longitude:(float)arg5 geoSupplier:(int)arg6 partnerarg:(id)arg7 psk:(id)arg8;
...
- (void)connectBusinessWifi:(id)arg1 province:(id)arg2 city:(id)arg3 ssid:(id)arg4 apid:(long long)arg5 latitude:(float)arg6 longitude:(float)arg7 geoSupplier:(int)arg8 partnerarg:(id)arg9 phoneNumber:(id)arg10 psk:(id)arg11;

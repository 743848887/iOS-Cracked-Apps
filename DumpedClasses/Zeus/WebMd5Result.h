...
@interface WebMd5Result : GPBMessage
{
}
...
@property(nonatomic) _Bool hasWebContent; // @dynamic hasWebContent;
@property(copy, nonatomic) NSString *result; // @dynamic result;
@property(copy, nonatomic) NSString *webContent; // @dynamic webContent;

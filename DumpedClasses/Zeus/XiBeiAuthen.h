...
@interface XiBeiAuthen : CCWINetProvider
{
    int _apid;
...
+ (_Bool)isXiBeiWiFiWithResponseData:(id)arg1;
...
- (id)timestamp;
- (_Bool)checkNetWorkWithError:(id)arg1;
- (void)XiBeiConnectWithError:(id)arg1;
- (void)XiBeiCheckSMSWithError:(id)arg1;
- (void)XiBeiGetSMSCheckWithError:(id)arg1 phoneNumber:(id)arg2;
- (void)initXiBeiProder:(id)arg1 partnerarg:(id)arg2 ssid:(id)arg3 apid:(int)arg4;
- (id)init;

...
- (void)recordWatchError:(NSString *)arg1 message:(NSString *)arg2 error:(NSError *)arg3 liveReport:(NSData *)arg4;
- (void)recordError:(NSString *)arg1 message:(NSString *)arg2 error:(NSError *)arg3 liveReport:(NSData *)arg4;
- (void)recordWatchError:(NSString *)arg1 message:(NSString *)arg2 exception:(NSException *)arg3 liveReport:(NSData *)arg4;
...
- (int)recordWatchEvent:(NSString *)arg1 withParameters:(NSDictionary *)arg2;

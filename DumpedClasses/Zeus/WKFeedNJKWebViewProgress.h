...
@protocol UIWebViewDelegate, WKFeedNJKWebViewProgressDelegate;

@interface WKFeedNJKWebViewProgress : NSObject <UIWebViewDelegate>
{
    ...
    _Bool _interactive;
    float _progress;
    id <WKFeedNJKWebViewProgressDelegate> _progressDelegate;
...
@property(nonatomic) __weak id <WKFeedNJKWebViewProgressDelegate> progressDelegate; // @synthesize progressDelegate=_progressDelegate;
- (void).cxx_destruct;

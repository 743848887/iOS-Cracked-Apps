...
@interface WITFHppleElement : NSObject
{
    NSDictionary *node;
    _Bool isXML;
    NSString *encoding;
    WITFHppleElement *parent;
}

+ (id)hppleElementWithNode:(id)arg1 isXML:(_Bool)arg2 withEncoding:(id)arg3;
@property(nonatomic) WITFHppleElement *parent; // @synthesize parent;
...
@property(readonly, nonatomic) WITFHppleElement *firstChild;

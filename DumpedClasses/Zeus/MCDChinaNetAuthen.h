...
@interface MCDChinaNetAuthen : CCWINetProvider
{
    _Bool _isMCD1;
    int _apid;
...
+ (_Bool)isMCDChinaNetWiFiWithResponseData:(id)arg1;
@property(nonatomic) int apid; // @synthesize apid=_apid;
@property(nonatomic) _Bool isMCD1; // @synthesize isMCD1=_isMCD1;
...
- (void)dealloc;
- (id)replaceWithRegularStr:(id)arg1 content:(id)arg2 replaceStr:(id)arg3;
- (id)timestamp;
- (void)MCDCheckSMSWithError:(id)arg1;
- (void)MCDGetSMSCheckWithError:(id)arg1 phoneNumber:(id)arg2;
- (void)initMCDProder:(id)arg1 partnerarg:(id)arg2 ssid:(id)arg3 apid:(int)arg4;
- (id)init;

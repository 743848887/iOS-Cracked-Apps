...
@class QYMCinemaInfoRequest;

@interface QYMCinemaInfoManager : JSONDataManager
{
    QYMCinemaInfoRequest *_request;
...
@property(retain, nonatomic) QYMCinemaInfoRequest *request; // @synthesize request=_request;

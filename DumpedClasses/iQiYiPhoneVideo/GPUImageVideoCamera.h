...
@class AVCaptureAudioDataOutput, AVCaptureDevice, AVCaptureDeviceInput, AVCaptureSession, AVCaptureVideoDataOutput, GLProgram, GPUImageFramebuffer, GPUImageTwoInputFilter, NSDate, NSObject, NSString;
...
@interface GPUImageVideoCamera : GPUImageOutput <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
{
    ...
    struct opaqueCMSampleBuffer *zeroDataFillAudio;
    char *zeroAudioData;

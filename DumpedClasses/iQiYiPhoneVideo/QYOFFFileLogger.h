...
#import "QYOFFAbstractLogger.h"

#import "QYOfflineLogger-Protocol.h"

@class NSFileHandle, NSObject, NSString, QYOfflineLogFileInfo;
@protocol OS_dispatch_queue, OS_dispatch_source, QYOfflineLogFileManager, QYOfflineLogFormatter;

@interface QYOFFFileLogger : QYOFFAbstractLogger <QYOfflineLogger>
{
    id <QYOfflineLogFileManager> _logFileManager;
    QYOfflineLogFileInfo *_currentLogFileInfo;
    ...
    id <QYOfflineLogFileManager> logFileManager;
}
...
@property(readonly, nonatomic) id <QYOfflineLogFileManager> logFileManager; // @synthesize logFileManager;
- (void).cxx_destruct;
...
@property(retain, nonatomic) id <QYOfflineLogFormatter> logFormatter;

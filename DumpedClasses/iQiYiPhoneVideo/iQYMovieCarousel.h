...
@protocol iQYMovieCarouselDataSource, iQYMovieCarouselDelegate;

@interface iQYMovieCarousel : UIView
{
    ...
    _Bool _scrolling;
    _Bool _didDrag;
    id <iQYMovieCarouselDataSource> _dataSource;
    id <iQYMovieCarouselDelegate> _delegate;
    long long _type;
    double _perspective;
...
@property(nonatomic) __weak id <iQYMovieCarouselDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) __weak id <iQYMovieCarouselDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void).cxx_destruct;
- (void)didPan:(id)arg1;
- (void)didTap:(id)arg1;
...
- (long long)circularQYMovieCarouselItemCount;

...
@interface QYPPCardCircleSubViewController : PPao_CircleSubViewController <PPBaseCardDataDelegate, PPPlayerDispatcherV3Delegate>
{
...
- (_Bool)p_checkForShareFeed:(id)arg1;

...
@class QYCinemaDetailData, QYCinemaDetailRequest;

@interface QYCinemaDetailManager : JSONDataManager
{
    QYCinemaDetailRequest *_request;
    unsigned long long _dealEndTime;
    unsigned long long _dealStartTime;
    unsigned long long _requestEndTime;
    QYCinemaDetailData *_cacheData;
}

@property(retain, nonatomic) QYCinemaDetailData *cacheData; // @synthesize cacheData=_cacheData;
...
@property(retain, nonatomic) QYCinemaDetailRequest *request; // @synthesize request=_request;
- (void)loadData;

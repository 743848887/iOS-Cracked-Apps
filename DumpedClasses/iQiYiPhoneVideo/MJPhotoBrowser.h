...
@class MJPhotoToolbar, MJPhotoViewCache, NSArray, NSMutableSet, NSString, UIScrollView, UIView;
...
@interface MJPhotoBrowser : NSObject <MJPhotoViewDelegate, MJPhotoToolbarDelegate, UIScrollViewDelegate>
{
    ...
    MJPhotoViewCache *_photoViewCache;
}

@property(retain, nonatomic) MJPhotoViewCache *photoViewCache; // @synthesize photoViewCache=_photoViewCache;

...
#import "QYTruncateTailLabel-Protocol.h"
#import "UIGestureRecognizerDelegate-Protocol.h"

@class NSArray, NSAttributedString, NSDataDetector, NSDictionary, NSString, UIImageView, UITapGestureRecognizer;
@protocol QYTruncateTailLabelDelegate;

@interface QYTruncateTailLabel : UILabel <QYTruncateTailLabel, UIGestureRecognizerDelegate>
{
    ...
    id <QYTruncateTailLabelDelegate> _delegate;
    UIImageView *_tailView;
}

@property(retain, nonatomic) UIImageView *tailView; // @synthesize tailView=_tailView;
@property(nonatomic) __weak id <QYTruncateTailLabelDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) _Bool isImageTail; // @synthesize isImageTail;

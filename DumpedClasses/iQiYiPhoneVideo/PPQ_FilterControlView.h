...
@class GPUBridgeFilter, GPUImageCropFilter, GPUImageMovieWriter, GPUImageVideoCamera, GPUImageView, NSMutableArray, NSObject, NSString, NSTimer, PPQ_CameraModeView, PPQ_CameraProgressView, PPQ_CameraSlider, PPQ_CameraTimeView, PPao_FilterListView, UIImageView, UIScrollView;

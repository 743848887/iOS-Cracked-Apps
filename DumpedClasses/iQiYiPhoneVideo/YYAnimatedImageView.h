...
@interface YYAnimatedImageView : UIImageView
{
    ...
    unsigned long long _currentAnimatedImageIndex;
...
@property(nonatomic) unsigned long long currentAnimatedImageIndex; // @synthesize currentAnimatedImageIndex=_currentAnimatedImageIndex;

...
- (id)url;
- (id)initWithPlatform:(long long)arg1 uid:(id)arg2 appKey:(id)arg3 appVersion:(id)arg4 vipUid:(id)arg5 plugin:(id)arg6 inited:(id)arg7 type:(long long)arg8 framework:(long long)arg9;

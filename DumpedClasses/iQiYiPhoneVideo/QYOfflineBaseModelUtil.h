...
+ (id)getYiDongFlowUserCode;
+ (long long)getYiDongFlowStatus;
+ (_Bool)getYiDongFlowSwitch;
+ (long long)getDianXinFlowStatus;
+ (_Bool)getDianXinFlowSwitch;
+ (id)getLianTongFlowUserCode;
+ (long long)getLianTongFlowType;
+ (long long)getLianTongFlowStatus;
+ (_Bool)getLianTongFlowSwitch;

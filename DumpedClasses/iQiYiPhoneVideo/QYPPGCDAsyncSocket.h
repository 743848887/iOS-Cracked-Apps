...
@class NSData, NSMutableArray, QYPPGCDAsyncReadPacket, QYPPGCDAsyncSocketPreBuffer, QYPPGCDAsyncWritePacket;
@protocol OS_dispatch_queue, OS_dispatch_source;

@interface QYPPGCDAsyncSocket : NSObject
{
    unsigned int flags;
    ...
    QYPPGCDAsyncReadPacket *currentRead;
    QYPPGCDAsyncWritePacket *currentWrite;
    unsigned long long socketFDBytesAvailable;
    QYPPGCDAsyncSocketPreBuffer *preBuffer;
    CDStruct_4210025a streamContext;
    struct __CFReadStream *readStream;
    struct __CFWriteStream *writeStream;
    struct SSLContext *sslContext;
    QYPPGCDAsyncSocketPreBuffer *sslPreBuffer;

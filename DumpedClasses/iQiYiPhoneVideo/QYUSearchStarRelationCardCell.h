...
#import "QYUStarRelationDescExpandProtocol-Protocol.h"

@class NSString;

@interface QYUSearchStarRelationCardCell : QYUPhoneCardBaseCell <QYUStarRelationDescExpandProtocol>
{
}
...
- (void)expandDesciptionWithExpandHeight:(double)arg1;

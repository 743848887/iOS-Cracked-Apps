...
@class NSString, QYUPaopaoBoardHomeView;

@interface QYUPaopaoBoardHomeCell : QYUPhoneCardBaseCell <QYPhoneGestureProtocol>
{
    QYUPaopaoBoardHomeView *_paopaoView;
}

+ (id)getCellObjByContainer:(id)arg1 andIndex:(long long)arg2;
+ (long long)getLinesByCardData:(id)arg1 andShowNum:(long long)arg2;
+ (void)load;
@property(retain, nonatomic) QYUPaopaoBoardHomeView *paopaoView; // @synthesize paopaoView=_paopaoView;
- (void).cxx_destruct;

...
@interface QiDanInsertData : NSObject
{
    QY_Album *_album;
    QY_Tvset *_tvset;
    NSString *_seek_time;
...
@property(retain, nonatomic) NSString *ugc; // @synthesize ugc=_ugc;
@property(retain, nonatomic) NSString *reminder_mpd; // @synthesize reminder_mpd=_reminder_mpd;

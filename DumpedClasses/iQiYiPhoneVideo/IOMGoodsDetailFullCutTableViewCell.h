...
@interface IOMGoodsDetailFullCutTableViewCell : UITableViewCell
{
    _Bool _didSetupConstraints;
    CDUnknownBlockType _handleFullCutClickes;
    UIButton *_bgBtn;
    UIView *_sepview;
    UILabel *_tipsLabel;
    UILabel *_infoLabel;
...
@property(copy, nonatomic) CDUnknownBlockType handleFullCutClickes; // @synthesize handleFullCutClickes=_handleFullCutClickes;
- (void).cxx_destruct;

...
@protocol OS_dispatch_queue, QYOfflineLogger;

@interface QYOfflineLoggerNode : NSObject
{
    id <QYOfflineLogger> _logger;
...
@property(readonly, nonatomic) id <QYOfflineLogger> logger; // @synthesize logger=_logger;
- (void).cxx_destruct;
- (void)dealloc;

...
#import "QYUMovieOrderOneCellItemViewDelegate-Protocol.h"

@class NSMutableArray, NSString;

@interface QYUMovieOrderOneCell : QYUPhoneCardBaseCell <QYUMovieOrderOneCellItemViewDelegate>
{
...
- (void)movieOrderOneCellItemViewClicked:(id)arg1;

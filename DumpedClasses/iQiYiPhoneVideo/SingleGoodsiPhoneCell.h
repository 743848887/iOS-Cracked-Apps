...
@interface SingleGoodsiPhoneCell : UITableViewCell
{
    ...
    UIImageView *_priceCover;
}

@property(retain, nonatomic) UIImageView *priceCover; // @synthesize priceCover=_priceCover;

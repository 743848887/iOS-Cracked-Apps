...
#import "QEMPTrackingInfo-Protocol.h"

@class NSString, QEMPElement;
@protocol OS_dispatch_source;

@interface QEMPBasicTrackingInfo : NSObject <QEMPTrackingInfo>
{
    id target;
    SEL selector;
...
@property(copy, nonatomic) QEMPElement *element; // @synthesize element;

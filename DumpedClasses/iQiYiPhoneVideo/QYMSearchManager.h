...
@class QYMSearchRequest;

@interface QYMSearchManager : JSONDataManager
{
    QYMSearchRequest *_request;
...
@property(retain, nonatomic) QYMSearchRequest *request; // @synthesize request=_request;

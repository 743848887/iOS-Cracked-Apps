...
@interface QYPayIndicatorView : UIView <CAAnimationDelegate>
{
...
+ (void)removeIndicatorOnView:(id)arg1;
+ (void)showIndicatorWithType:(long long)arg1 onView:(id)arg2;
...
- (void)__doAnimationWithIndicatorType:(long long)arg1;
- (void)__generateLayoutWithIndicatorType:(long long)arg1;
- (id)initWithIndicatorType:(long long)arg1;
- (void)dealloc;

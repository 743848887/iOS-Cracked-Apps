...
#import "QYAttributedLabel-Protocol.h"
#import "UIGestureRecognizerDelegate-Protocol.h"

@class NSArray, NSAttributedString, NSDataDetector, NSDictionary, NSString, QYAttributedLabelLink, UIColor, UILongPressGestureRecognizer;
@protocol QYAttributedLabelDelegate;

@interface QYAttributedLabel : UILabel <QYAttributedLabel, UIGestureRecognizerDelegate>
{
    ...
    id <QYAttributedLabelDelegate> _delegate;
    ...
    NSArray *_linkModels;
    QYAttributedLabelLink *_activeLink;
...
@property(retain, nonatomic) QYAttributedLabelLink *activeLink; // @synthesize activeLink=_activeLink;
...
@property(nonatomic) id <QYAttributedLabelDelegate> delegate; // @synthesize delegate=_delegate;

...
@class NSDate, NSString, UIColor, UILabel;
...
- (void)placeSubviews;
- (void)prepare;
- (long long)convertState:(int)arg1;
@property(nonatomic, getter=isUpdatedTimeHidden) _Bool updatedTimeHidden;
@property(nonatomic, getter=isStateHidden) _Bool stateHidden;
@property(readonly, nonatomic) UILabel *updatedTimeLabel;
@property(retain, nonatomic) UIColor *textColor;
@property(copy, nonatomic) NSString *dateKey;
@property(nonatomic) double customTop;

...
@class QYNewPlayerControlView, UIGestureRecognizer, UIPinchGestureRecognizer;

@protocol QYNewPlayerControlViewDelegate <NSObject>
...
- (void)updateControlViewByLayout:(QYNewPlayerControlView *)arg1;
@end

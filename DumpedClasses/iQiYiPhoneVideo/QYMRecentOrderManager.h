...
@class QYMRecentOrderRequest;

@interface QYMRecentOrderManager : JSONDataManager
{
    QYMRecentOrderRequest *_request;
...
@property(retain, nonatomic) QYMRecentOrderRequest *request; // @synthesize request=_request;

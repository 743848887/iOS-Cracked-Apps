...
@class QYMOrderRePurchaseTicketData, QYMRePurchaseTicketsRequest;

@interface QYMRePurchaseTicketsManager : JSONDataManager
{
    QYMRePurchaseTicketsRequest *_request;
    unsigned long long _dealEndTime;
    unsigned long long _dealStartTime;
    unsigned long long _requestEndTime;
    QYMOrderRePurchaseTicketData *_cacheData;
}

@property(retain, nonatomic) QYMOrderRePurchaseTicketData *cacheData; // @synthesize cacheData=_cacheData;
...
@property(retain, nonatomic) QYMRePurchaseTicketsRequest *request; // @synthesize request=_request;

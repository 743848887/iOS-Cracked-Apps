...
@class QYCinemaOrderListData, QYCinemaOrderListRequest;

@interface QYCinemaOrderListManager : JSONDataManager
{
    QYCinemaOrderListRequest *_request;
    unsigned long long _dealEndTime;
    unsigned long long _dealStartTime;
    unsigned long long _requestEndTime;
    QYCinemaOrderListData *_cacheData;
}

@property(retain, nonatomic) QYCinemaOrderListData *cacheData; // @synthesize cacheData=_cacheData;
...
@property(retain, nonatomic) QYCinemaOrderListRequest *request; // @synthesize request=_request;

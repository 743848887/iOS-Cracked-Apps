...
@interface IOMGoodsDetailVIPLoginTableViewCell : UITableViewCell
{
    _Bool _didSetupConstraints;
    CDUnknownBlockType _handleVIPLoginClickes;
    UIButton *_bgBtn;
    UIView *_sepview;
    UILabel *_tipsLabel;
    UILabel *_infoLabel;
...
@property(copy, nonatomic) CDUnknownBlockType handleVIPLoginClickes; // @synthesize handleVIPLoginClickes=_handleVIPLoginClickes;
- (void).cxx_destruct;

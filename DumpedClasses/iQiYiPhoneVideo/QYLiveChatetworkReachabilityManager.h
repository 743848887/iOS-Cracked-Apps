...
@interface QYLiveChatetworkReachabilityManager : NSObject
{
    _Bool _isStartMonitoring;
...
@property(nonatomic) _Bool isStartMonitoring; // @synthesize isStartMonitoring=_isStartMonitoring;
- (void).cxx_destruct;

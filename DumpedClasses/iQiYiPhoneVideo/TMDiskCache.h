...
@protocol OS_dispatch_queue, TMDiskCacheCustomArchiveDelegate;
...
@interface TMDiskCache : NSObject
{
    ...
    id <TMDiskCacheCustomArchiveDelegate> _customArchiveDelegate;
...
@property(nonatomic) __weak id <TMDiskCacheCustomArchiveDelegate> customArchiveDelegate; // @synthesize customArchiveDelegate=_customArchiveDelegate;

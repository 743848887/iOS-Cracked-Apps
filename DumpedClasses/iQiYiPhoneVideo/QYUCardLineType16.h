...
@class NSArray, NSMutableArray, NSMutableDictionary, NSString, QYUCardDataV3, QYUTextSimple, UICollectionView, UICollectionViewFlowLayout;

@interface QYUCardLineType16 : UITableViewCell <UICollectionViewDelegate, UICollectionViewDataSource>
{
    UICollectionView *collectionView;
    UICollectionViewFlowLayout *flowlayout;
    NSArray *currentBlockDatas;
    QYUTextSimple *textSimple;
    NSMutableDictionary *blockWidthDict;
    NSArray *_data;

...
@class NSObject, NSString, QYGLTextViewInternal, UIColor, UIFont, UITextView;
@protocol QYGLGrowingTextViewDelegate;

@interface QYGLGrowingTextView : UIView <UITextViewDelegate>
{
    QYGLTextViewInternal *internalTextView;
    int minHeight;
    int maxHeight;
    ...
    NSObject<QYGLGrowingTextViewDelegate> *delegate;
...
@property NSObject<QYGLGrowingTextViewDelegate> *delegate; // @synthesize delegate;

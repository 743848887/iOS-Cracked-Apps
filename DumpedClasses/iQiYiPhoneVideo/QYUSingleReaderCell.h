...
@class NSString, QYUSearchPicTextTagsView, UILabel;

@interface QYUSingleReaderCell : QYUPhoneCardBaseCell <QYPhoneGestureProtocol>
{
    QYUSearchPicTextTagsView *tagsView;
    double cellWidth;
    UILabel *tryReadLabel;
}

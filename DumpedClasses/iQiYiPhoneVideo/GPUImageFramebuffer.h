...
@property(nonatomic) unsigned long long framebufferReferenceCount; // @synthesize framebufferReferenceCount=_framebufferReferenceCount;
@property(readonly) _Bool missingFramebuffer; // @synthesize missingFramebuffer=_missingFramebuffer;
@property(readonly) unsigned int framebuffer; // @synthesize framebuffer;

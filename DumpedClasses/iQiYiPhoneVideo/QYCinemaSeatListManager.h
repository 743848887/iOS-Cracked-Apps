...
@class QYCinemaSeatListRequest;

@interface QYCinemaSeatListManager : JSONDataManager
{
    QYCinemaSeatListRequest *_request;
...
@property(retain, nonatomic) QYCinemaSeatListRequest *request; // @synthesize request=_request;

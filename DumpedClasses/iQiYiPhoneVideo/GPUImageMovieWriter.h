...
@interface GPUImageMovieWriter : NSObject <GPUImageInput>
{
    ...
    long long _shouldDroppedVideoFrameCount;
    struct opaqueCMFormatDescription *_passthroughAudioFormatDescription;
...
@property(nonatomic) struct opaqueCMFormatDescription *passthroughAudioFormatDescription; // @synthesize passthroughAudioFormatDescription=_passthroughAudioFormatDescription;
@property(nonatomic) long long shouldDroppedVideoFrameCount; // @synthesize shouldDroppedVideoFrameCount=_shouldDroppedVideoFrameCount;

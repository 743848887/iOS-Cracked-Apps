...
@class IOMTextViewInternal, NSObject, NSString, UIColor, UIFont, UITextView;
@protocol IOMGrowingTextViewDelegate;

@interface IOMGrowingTextView : UIView <UITextViewDelegate>
{
    IOMTextViewInternal *internalTextView;
    int minHeight;
    int maxHeight;
    ...
    NSObject<IOMGrowingTextViewDelegate> *delegate;
    ...
    struct _NSRange _beforeRange;
}

@property(nonatomic) struct _NSRange beforeRange; // @synthesize beforeRange=_beforeRange;
...
@property NSObject<IOMGrowingTextViewDelegate> *delegate; // @synthesize delegate;
...
- (void)refreshHeight;
- (void)clearText;
- (void)updateTextWithPreviousText:(id)arg1 brandText:(id)arg2;
- (void)textViewDidChange:(id)arg1;
- (void)parseAttributeText:(id)arg1;

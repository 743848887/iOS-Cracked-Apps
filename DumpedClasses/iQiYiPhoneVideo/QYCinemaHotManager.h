...
@class QYCinemaHotData, QYCinemaHotRequest;

@interface QYCinemaHotManager : JSONDataManager
{
    QYCinemaHotRequest *_request;
    unsigned long long _dealEndTime;
    unsigned long long _dealStartTime;
    unsigned long long _requestEndTime;
    QYCinemaHotData *_cacheData;
}

@property(retain, nonatomic) QYCinemaHotData *cacheData; // @synthesize cacheData=_cacheData;
...
@property(retain, nonatomic) QYCinemaHotRequest *request; // @synthesize request=_request;
- (void)loadData;

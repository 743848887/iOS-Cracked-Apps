...
@interface SDImageCache : NSObject
{
    ...
    NSString *_noDelCachePath;
}

+ (id)sharedImageCache;
@property(retain, nonatomic) NSString *noDelCachePath; // @synthesize noDelCachePath=_noDelCachePath;
...
- (void)storeImage:(id)arg1 recalculateFromImage:(_Bool)arg2 imageData:(id)arg3 forKey:(id)arg4 toDisk:(_Bool)arg5 cacheType:(long long)arg6;
...
- (id)sd_noDecompressImageForKey:(id)arg1;
- (id)sd_my_diskImageForKey:(id)arg1;

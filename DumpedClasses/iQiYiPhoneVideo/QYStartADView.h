...
@class AdsClient, CupidAd, NSString, NSThread, NSTimer, QYStartAdPlayerController, UILabel, UIWindow;
...
@property(nonatomic) id <QYStartADViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void)playToEnd;
- (void)playError;

...
- (void)downloadWithURL:(id)arg1 delegate:(id)arg2 options:(unsigned long long)arg3;
- (void)downloadWithURL:(id)arg1 delegate:(id)arg2 options:(unsigned long long)arg3 userInfo:(id)arg4;
- (void)downloadWithURL:(id)arg1 delegate:(id)arg2;
- (void)downloadWithURL:(id)arg1 delegate:(id)arg2 options:(unsigned long long)arg3 success:(CDUnknownBlockType)arg4 failure:(CDUnknownBlockType)arg5;

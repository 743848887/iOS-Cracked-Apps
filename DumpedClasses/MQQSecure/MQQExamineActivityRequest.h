...
@interface MQQExamineActivityRequest : MQQSharkBaseRequest
{
    NSArray *_activityResults;
}

@property(readonly, nonatomic) NSArray *activityResults; // @synthesize activityResults=_activityResults;

...
@class MQQNetworkQualityModel, MQQURLSession, NSData, NSDictionary, NSError, NSFileHandle, NSLock, NSMutableData, NSMutableDictionary, NSMutableURLRequest, NSString, NSURL, NSURLConnection, NSURLSession, NSURLSessionTask;
...
@interface MQQHttpRequest : NSObject <NSURLConnectionDataDelegate, NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSURLConnectionDelegate>
{
    ...
    MQQNetworkQualityModel *_networkQualityModel;
...
@property(retain, nonatomic) MQQNetworkQualityModel *networkQualityModel; // @synthesize networkQualityModel=_networkQualityModel;

...
@interface MQQMCMessageCheckRequest : MQQSharkBaseRequest
{
    NSDictionary *_results;
    NSArray *_allMessages;
}

@property(retain, nonatomic) NSArray *allMessages; // @synthesize allMessages=_allMessages;

...
+ (void)load;
+ (void)deleteModelFromURLWithString:(id)arg1 params:(id)arg2 completion:(CDUnknownBlockType)arg3;
+ (void)putModelWithNewModelFromURLWithString:(id)arg1 params:(id)arg2 completion:(CDUnknownBlockType)arg3;
+ (void)postModelFromURLWithString:(id)arg1 params:(id)arg2 completion:(CDUnknownBlockType)arg3;
+ (void)getModelsFromURLWithString:(id)arg1 params:(id)arg2 preprocessBlock:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;
+ (void)getModelsFromURLWithString:(id)arg1 params:(id)arg2 completion:(CDUnknownBlockType)arg3;
+ (void)getModelFromURLWithString:(id)arg1 params:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)__setup__;
- (void)saveToDB;
- (void)putModelFromURLWithString:(id)arg1 params:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (id)keysShouldUpdate;

...
@class DDXMLElement, EMGCDAsyncSocket, EMGCDMulticastDelegate, NSArray, NSCountedSet, NSData, NSDate, NSError, NSMutableArray, NSMutableDictionary, NSString, XMPPIDTracker, XMPPJID, XMPPParser, XMPPPresence, XMPPSRVResolver;
@protocol IXMPPCompressor, XMPPCustomBinding, XMPPSASLAuthentication, XMPPStreamDelegate;

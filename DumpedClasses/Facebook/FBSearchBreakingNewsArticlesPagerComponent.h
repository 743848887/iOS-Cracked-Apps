...
@interface FBSearchBreakingNewsArticlesPagerComponent : CKComponent
{
    vector_4cad59d0 _children;
    shared_ptr_6a94d7a4 _mountedChildren;
    struct FBSearchBreakingNewsArticlesPagerComponentOptions _options;
}

+ (id)newWithChildren:(const vector_4cad59d0 *)arg1 options:(const struct FBSearchBreakingNewsArticlesPagerComponentOptions *)arg2;
@property(readonly, nonatomic) struct FBSearchBreakingNewsArticlesPagerComponentOptions options; // @synthesize options=_options;

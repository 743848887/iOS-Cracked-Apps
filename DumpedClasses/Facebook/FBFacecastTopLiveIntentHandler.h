...
@class FBIntent, FBUserSession, NSString, UIView;
@protocol FBNavigationCoordinator;

@interface FBFacecastTopLiveIntentHandler : NSObject <FBIntentHandler>
{
    id <FBNavigationCoordinator> _navigationCoordinator;
    FBUserSession *_session;
    FBIntent *_intent;
    UIView *_activityView;
    _Bool _isHandlingIntent;
}
...
- (id)_videoChannelIntentTargetFromChannel:(id)arg1;

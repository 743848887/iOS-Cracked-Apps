...
@class FBFeedGraphQLConnectionManager, FBGraphQLConsistentLookasideCache, FBGroupEditLocationListenerAnnouncer, FBListLogger, FBListViewLayoutListenerAnnouncer, FBUserSession, NSObject, NSString;
...
@interface FBGroupEditLocationToolbox : FBSectionComponentToolbox <FBSectionComponentToolbox>
{
    FBGroupEditLocationListenerAnnouncer *_editLocationListenerAnnouncer;
}

@property(readonly, nonatomic) __weak FBGroupEditLocationListenerAnnouncer *editLocationListenerAnnouncer; // @synthesize editLocationListenerAnnouncer=_editLocationListenerAnnouncer;
- (void).cxx_destruct;
- (id)initWithContext:(id)arg1 editLocationListenerAnnouncer:(id)arg2;

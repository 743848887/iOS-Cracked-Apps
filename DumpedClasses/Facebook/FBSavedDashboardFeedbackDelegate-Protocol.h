...
@class FBMemTimelineAppCollectionItem, FBSavedDashboardFeedbackManager, NSArray;

@protocol FBSavedDashboardFeedbackDelegate <NSObject>
- (_Bool)saveFeedbackManager:(FBSavedDashboardFeedbackManager *)arg1 feedBackTypeSupported:(int)arg2;

...
+ (id)newWithApplication:(id)arg1 isApplicationInstalled:(_Bool)arg2 imageDownloader:(id)arg3 action:(CKTypedComponentAction_4b39899e)arg4 fontFoundry:(id)arg5;

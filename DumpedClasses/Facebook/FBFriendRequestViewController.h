...
@class FBComponentTableViewDataSource, FBFriendRequestTableViewDataSourceHelper, FBFriendingPossibilitiesDataCoordinator, FBFriendingPossibilitiesDataSource, FBFriendingToolbox, FBJewelController, FBPullToRefreshView, FBUserSession, NSMutableDictionary, NSMutableSet, NSObject, NSString, UITableView;

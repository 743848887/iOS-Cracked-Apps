...
@protocol FBGroupCasualGroupsFacepilePaginatedDataControllerDelegate;

@interface FBGroupCasualGroupsFacepilePaginatedDataController : NSObject <FBGraphQLConnectionControllerLoadListener, FBGraphQLConnectionControllerListener>
{
    NSString *_groupID;
    FBUserSession *_session;
    FBGraphQLConnectionController *_connectionController;
    NSArray *_groupMembers;
    id <FBGroupCasualGroupsFacepilePaginatedDataControllerDelegate> _delegate;
}

@property(nonatomic) __weak id <FBGroupCasualGroupsFacepilePaginatedDataControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)_updateGroupMembers:(id)arg1;
- (void)_groupMembersByAddingGroupMemberEdges:(id)arg1;

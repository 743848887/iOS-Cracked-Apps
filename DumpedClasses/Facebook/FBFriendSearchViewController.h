...
@class FBComponentTableViewDataSource, FBFriendingToolbox, FBPeopleSearchDataSourceHelper, FBPeopleSearchStream, FBTransientViewStateManager, FBUserSession, NSNumber, NSObject, NSString, UISearchBar, UITableView;

...
#import "FBThirdPartyAppAuthViewControlling-Protocol.h"

@class FBThirdPartyAppAuthController, NSString;

@interface FBThirdPartyAppAuthViewController : UIViewController <FBThirdPartyAppAuthViewControlling>
{
    CDUnknownBlockType _viewProvidingBlock;
...
- (id)initWithAccessToken:(id)arg1 viewProvider:(CDUnknownBlockType)arg2 requesterConfiguration:(id)arg3;

...
#import "FBAccountRecoveryOtherSessionsFlowControlling-Protocol.h"
#import "FBAuthRecoveryControlling-Protocol.h"
#import "FBAuthRecoveryControllingDelegate-Protocol.h"

@class FBAccountRecoveryChangePasswordFlowController, FBAccountRecoveryFlowData, NSString;
...
- (void).cxx_destruct;
- (void)didContinueWithLogOutOtherSessions:(_Bool)arg1;

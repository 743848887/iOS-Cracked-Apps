...
@class FBVideoHomeGuideDataFetcher, FBVideoHomeInAppNotificationListenerAnnouncer, NSDate, NSString;
...
@property(retain, nonatomic) NSDate *lastNotificationDate; // @synthesize lastNotificationDate=_lastNotificationDate;
- (void).cxx_destruct;

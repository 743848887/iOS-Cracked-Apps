...
@property(nonatomic) _Bool displayTopDivider; // @synthesize displayTopDivider=_displayTopDivider;
@property(nonatomic) _Bool displayEditButton; // @synthesize displayEditButton=_displayEditButton;
@property(nonatomic) unsigned long long showSeparators; // @synthesize showSeparators=_showSeparators;
- (void).cxx_destruct;

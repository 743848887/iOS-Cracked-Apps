...
@protocol FBGraphQLService, FBGroupLinkedGroupsCreateLinkInputHandler, FBIntentHandler, FBListViewControllerActionHandler, FBListViewNavigationSearchBarUpdater, FBListViewStateManagerProtocol, FBNavigationCoordinator, FBSectionComponentScrollManagerProtocol;

@interface FBGroupLinkedGroupsCreateLinkToolbox : FBSectionComponentToolbox <FBSectionComponentToolbox>
{
    id <FBGroupLinkedGroupsCreateLinkInputHandler> _inputHandler;
}

@property(readonly, nonatomic) __weak id <FBGroupLinkedGroupsCreateLinkInputHandler> inputHandler; // @synthesize inputHandler=_inputHandler;
- (void).cxx_destruct;
- (id)initWithContext:(id)arg1 inputHandler:(id)arg2;

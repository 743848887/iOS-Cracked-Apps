...
@property(readonly, nonatomic) long long paginatedBufferSize;
@property(readonly, nonatomic) long long paginatedRequestLimit;
...
- (FBGraphQLQuery *)paginatedQueryForEntityCardsInFriendListForTargetID:(NSString *)arg1 pageInfo:(FBMemPageInfo *)arg2 pageSize:(unsigned long long)arg3;

...
- (_Bool)_isDestructiveAction:(long long)arg1;
- (_Bool)_shouldShowReportOption;
- (_Bool)_shouldShowLeaveGroupOption;
- (_Bool)_shouldShowUnfollowOption;
- (_Bool)_shouldShowFollowOption;

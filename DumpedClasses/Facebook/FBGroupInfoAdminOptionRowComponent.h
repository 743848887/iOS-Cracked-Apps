...
@class FBGroupInfoManagementActionHandler, FBMemGroup, FBSectionComponentToolbox;

@interface FBGroupInfoAdminOptionRowComponent : CKCompositeComponent
{
    FBGroupInfoManagementActionHandler *_actionHandler;

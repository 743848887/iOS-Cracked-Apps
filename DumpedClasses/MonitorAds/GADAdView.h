...
@class AVPlayerLayer, GADAdViewState, GADImpressionTicketGestureRecognizer, GADVideoPlayer, NSOperationQueue, NSString, NSURL, NSURLRequest, UIAlertView, UIGestureRecognizer, UIScrollView, UIViewController, UIWebView;
...
@property(retain, nonatomic) GADImpressionTicketGestureRecognizer *impressionTicketGestureRecognizer; // @synthesize impressionTicketGestureRecognizer=_impressionTicketGestureRecognizer;

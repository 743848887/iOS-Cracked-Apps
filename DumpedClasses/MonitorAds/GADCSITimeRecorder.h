...
@property(nonatomic) BOOL reportIRT; // @synthesize reportIRT=_reportIRT;
...
@property(readonly) NSDictionary *completedVariables; // @synthesize completedVariables=_completedVariables;
@property(readonly) NSDictionary *ongoingVariables; // @synthesize ongoingVariables=_ongoingVariables;

...
@class NSArray, NSAttributedString, NSDictionary, NSString, UIColor, UIFont, UIImage, VZFBlockAction, VZFBlockGesture, VZFNode;
...
struct vector<cv::DMatch, std::__1::allocator<cv::DMatch>> {
    struct DMatch *_field1;
    struct DMatch *_field2;
    struct __compressed_pair<cv::DMatch *, std::__1::allocator<cv::DMatch>> {
        struct DMatch *_field1;
    } _field3;
};

struct vector<cv::KeyPoint, std::__1::allocator<cv::KeyPoint>> {
    struct KeyPoint *_field1;
    struct KeyPoint *_field2;
    struct __compressed_pair<cv::KeyPoint *, std::__1::allocator<cv::KeyPoint>> {
        struct KeyPoint *_field1;
    } _field3;
};
...
typedef struct vector<cv::DMatch, std::__1::allocator<cv::DMatch>> {
    struct DMatch *_field1;
    struct DMatch *_field2;
    struct __compressed_pair<cv::DMatch *, std::__1::allocator<cv::DMatch>> {
        struct DMatch *_field1;
...
typedef struct vector<cv::KeyPoint, std::__1::allocator<cv::KeyPoint>> {
    struct KeyPoint *_field1;
    struct KeyPoint *_field2;
    struct __compressed_pair<cv::KeyPoint *, std::__1::allocator<cv::KeyPoint>> {
        struct KeyPoint *_field1;

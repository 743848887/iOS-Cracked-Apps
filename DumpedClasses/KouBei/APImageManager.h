...
@class ImageCache2, NSLock, NSMutableDictionary, NSOperationQueue, NetworkSetting, TaskSchedulerMarket;
...
+ (id)replaceDomainWithUrlString:(id)arg1;
...
- (void)generateWatermarkUsingAFNetworking:(id)arg1 task:(id)arg2 progress:(CDUnknownBlockType)arg3 success:(CDUnknownBlockType)arg4 fail:(CDUnknownBlockType)arg5;
...
- (void)downloadWatermarkUseAfnetworking:(id)arg1 task:(id)arg2;
...
- (void)downloadThumbnailFromDjangoWithID:(id)arg1 request:(id)arg2 imageType:(unsigned long long)arg3 size:(struct CGSize)arg4 zoom:(id)arg5 zoom2:(id)arg6 isWebP:(_Bool)arg7 taskRecord:(id)arg8 useHttps:(_Bool)arg9;

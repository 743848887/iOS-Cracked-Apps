...
@protocol AliLoginDelegate, aluLoginDelegate, aluUIAppearanceDelegate;
...
@interface aluSDKInternal : NSObject
{
    ...
    id <AliLoginDelegate> _miscDelegate;
    NSString *_appID;
    NSString *_appKey;
    aluAppInfo *_appInfo;
...
@property(nonatomic) __weak id <AliLoginDelegate> miscDelegate; // @synthesize miscDelegate=_miscDelegate;

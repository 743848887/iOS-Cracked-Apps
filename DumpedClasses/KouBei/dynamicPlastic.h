...
- (void)createProperties:(id)arg1 forClass:(Class)arg2 forClassName:(id)arg3;
- (_Bool)createOneProperty:(id)arg1 forClass:(Class)arg2 checkPropertyExist:(_Bool)arg3;
- (_Bool)createOneProperty:(id)arg1 forClass:(Class)arg2;

...
#import "VideoRecorderWriterDelegate-Protocol.h"

@class APBeautyManager, APMRecorderFocusView, APMTextureView, APMVideoPreviewViewContainer, APVideoExportSetting, APVideoRemoteInfo, AVCaptureAudioDataOutput, AVCaptureConnection, AVCaptureDeviceInput, AVCaptureSession, AVCaptureStillImageOutput, AVCaptureVideoDataOutput, CLLocation, CLLocationManager, CMMotionManager, EAGLContext, NSDate, NSMutableDictionary, NSObject, NSOperationQueue, NSString, NSTimer, RecorderLightDarkView, RecorderLoadingView, UIImage, UILabel, VideoRecorderWriter;

...
@protocol O2OSearchContainerVCDelegate;
...
@property(readonly, nonatomic) double lastVoiceSearchTime; // @synthesize lastVoiceSearchTime=_lastVoiceSearchTime;

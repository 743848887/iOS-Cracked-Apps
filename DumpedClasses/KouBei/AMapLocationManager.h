...
@class AMapLocationNetworkManager, AMapLocationPrivateThread, CLLocationManager, NSArray, NSMapTable, NSMutableArray, NSSet, NSString;
...
@property(retain, nonatomic) AMapLocationNetworkManager *networkManager; // @synthesize networkManager=_networkManager;

...
@class KBCSAOrderExtendInfo, NSString;

@interface KBCSAO2OMyKoubeiOrderDetail : KBCSAToString
{
    ...
    KBCSAOrderExtendInfo *_orderExtendInfo;
    NSString *_orderBizType;
}

@property(retain, nonatomic) NSString *orderBizType; // @synthesize orderBizType=_orderBizType;
@property(retain, nonatomic) KBCSAOrderExtendInfo *orderExtendInfo; // @synthesize orderExtendInfo=_orderExtendInfo;

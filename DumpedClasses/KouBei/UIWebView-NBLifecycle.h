...
@protocol NBContentViewPageDelegate, PSDContentViewDelegate, PSDContentViewNavigationDelegate, PSDContentViewUIDelegate, PSDExternalWebViewDelegate, PSDViewControllerProtocol;
...
- (void)myFirstVisuallyNonEmptyLayout:(id)arg1;

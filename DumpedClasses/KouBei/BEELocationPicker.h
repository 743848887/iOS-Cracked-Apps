...
@class AMapPOI, APTableView, BEELocationLoadingView, BEELocationPickerParams, BEELocationSwitchTabView, LBSAddressInfo, NSMutableArray, NSMutableDictionary, NSString, UILabel, UISearchBar, UISearchDisplayController, UIView;

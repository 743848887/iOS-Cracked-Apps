...
@class ALPCardHeadItem, UIImageView, UILabel, UIView;

@interface ALPMemberHeadCell : VZListCell
{
    float _sizeOffset;
    ALPCardHeadItem *_headItem;
    UIView *_cardView;
...
@property(retain, nonatomic) ALPCardHeadItem *headItem; // @synthesize headItem=_headItem;
- (void).cxx_destruct;

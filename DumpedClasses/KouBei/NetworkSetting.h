...
@interface NetworkSetting : NSObject <SettingUpdateProtocal>
{
    ...
    _Bool _enableMassProxy4OfflineUpload;
    _Bool _enableMassProxy4UrlBuilder;
    _Bool _enablePing;
    _Bool _useNSBundle;
...
@property(nonatomic) _Bool enableMassProxy4UrlBuilder; // @synthesize enableMassProxy4UrlBuilder=_enableMassProxy4UrlBuilder;
@property(nonatomic) _Bool enableMassProxy4OfflineUpload; // @synthesize enableMassProxy4OfflineUpload=_enableMassProxy4OfflineUpload;

...
#import "O2OIndexLabelSelectDelegate-Protocol.h"
#import "O2OSyncManagerDelegate-Protocol.h"

@class APExceptionView, AUNavItemView, CDPSpaceView, MOBILECSAHomePageDynamicReponse, NSString, O2OCommonIndexLocationView, O2OIndexDataSource, O2OIndexDelegate, O2OIndexInvalidCityView, O2OIndexModel, O2OIndexPublishGuideMaskView, O2OIndexPublishView, O2OIndexShopListModel, O2OLocationCityInfo, O2OModelManager, UIActivityIndicatorView, UIButton, UIColor, UITableView, VZRefreshControl;
@protocol O2OIndexTemplateControllerPrivoder;

@interface O2OIndexViewController : O2OListViewController <O2OCDPAdapterPromotionProtocol, O2OCommonIndexLocationViewDelegate, O2OIndexInvalidCityViewDelegate, O2OIndexCacheDelegate, O2OIndexLabelSelectDelegate, O2OSyncManagerDelegate>
{
...
@property(nonatomic) _Bool isLoggin; // @synthesize isLoggin=_isLoggin;
...
- (void)setMiddleCustomNavigationItemTitleView;

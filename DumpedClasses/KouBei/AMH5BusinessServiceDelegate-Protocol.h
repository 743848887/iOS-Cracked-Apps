...
@class H5PSDController, NSError, NSURLRequest, UIColor, UIWebView;

@protocol AMH5BusinessServiceDelegate <NSObject>
...
- (UIColor *)shouldSetNavigationBarColor:(H5PSDController *)arg1;
@end

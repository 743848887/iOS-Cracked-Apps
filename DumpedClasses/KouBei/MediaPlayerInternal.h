...
@class APMediaPlyerLogInfo, APResourceLoader, AVURLAsset, NSDate, NSError, NSObject, NSString;
...
@property(retain, nonatomic) APMediaPlyerLogInfo *logInfo; // @synthesize logInfo=_logInfo;

...
@class ALPCreateMemberModel, ALPMemberCardListViewDataSource, ALPMemberCardListViewDelegate, ALPMemberCardPreviewModel, ALPNavigationBar, ALPQueryMemberInfoModel, AMCH5ServiceController, APActionSheet, APExceptionView, CardInfoResult, KABAOPRODMemberCardRequest, NSString;

@interface ALPApplyMemberCardViewController : ALPListViewController <UIActionSheetDelegate>
{
    _Bool _onlyPreview;
    float _timeDuration;

...
@interface NBConfiguration : NSObject
{
    ...
    _Bool _viewControllerProxyNotLazy;
    int _WKRetryTimes;
...
@property(nonatomic) _Bool viewControllerProxyNotLazy; // @synthesize viewControllerProxyNotLazy=_viewControllerProxyNotLazy;

...
@class AFEFaceScanNormalView, AFEProgressView, AFEScanErrorView, AFEStatusBar, AVAudioPlayer, NSString;

@interface AFEFaceScanView : UIView <AFEScanViewProtocol>
{
    _Bool _lock;
    UIView *_view;
    AFEStatusBar *_statusBar;
    AFEFaceScanNormalView *_scanView;
    AFEScanErrorView *_errorView;
    AFEProgressView *_progressView;
    long long _status;
...
@property(nonatomic) __weak AFEProgressView *progressView; // @synthesize progressView=_progressView;
@property(nonatomic) __weak AFEScanErrorView *errorView; // @synthesize errorView=_errorView;
@property(nonatomic) __weak AFEFaceScanNormalView *scanView; // @synthesize scanView=_scanView;
...
- (void)showPercent:(long long)arg1;

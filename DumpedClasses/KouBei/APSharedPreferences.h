...
@class APDatabaseConnection, APDatabaseLock, APExistenceTable, APLRUMemoryCache, APSharedPreferencesMemoryPolicy, NSMutableArray, NSMutableSet, NSString, RavenPreferences;
...
- (id)fetchDecryptData:(struct RVFMResultSet *)arg1 extension:(struct APDataCrypt *)arg2;

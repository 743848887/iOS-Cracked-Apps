...
#import "O2OVocieSearchDimmingViewDeleage-Protocol.h"
#import "O2OVoiceSearchBarDelegate-Protocol.h"
#import "UITableViewDataSource-Protocol.h"
#import "UITableViewDelegate-Protocol.h"

@class NSArray, NSDictionary, NSString, NSTimer, O2OSearchDisplayListModel, O2OSearchHotwordModel, O2OSearchMiddleDisplayVCModel, O2OSearchMiddleLogic, O2OSpellCheckModel, O2OVoiceHotWordModel, UITableView;
@protocol O2OSearchContainerVCDelegate, O2OSearchMiddleDisplayVCDelegate;

@interface O2OSearchMiddleDisplayVC : O2OListViewController <O2OCDPAdapterPromotionProtocol, O2OSearchBarDelegate, O2OVoiceSearchBarDelegate, O2OVocieSearchDimmingViewDeleage, O2OSearchDimmingViewDelegate, UITableViewDataSource, UITableViewDelegate>
{
    _Bool _keepQuery;
    ...
    O2OSpellCheckModel *_spellCheckModel;
    O2OVoiceHotWordModel *_voiceHotWordModel;
    NSString *_lastVoiceSearchText;
    double _startVoiceSearchTime;
    NSTimer *_voiceSearchTimer;
    struct SearchFlag _searchFlag;
}

@property(nonatomic) _Bool isVoiceSearching; // @synthesize isVoiceSearching=_isVoiceSearching;
@property(retain, nonatomic) NSTimer *voiceSearchTimer; // @synthesize voiceSearchTimer=_voiceSearchTimer;
@property(nonatomic) double startVoiceSearchTime; // @synthesize startVoiceSearchTime=_startVoiceSearchTime;
@property(retain, nonatomic) NSString *lastVoiceSearchText; // @synthesize lastVoiceSearchText=_lastVoiceSearchText;
@property(retain, nonatomic) O2OVoiceHotWordModel *voiceHotWordModel; // @synthesize voiceHotWordModel=_voiceHotWordModel;
@property(retain, nonatomic) O2OSpellCheckModel *spellCheckModel; // @synthesize spellCheckModel=_spellCheckModel;
...
@property(nonatomic) int preShowType; // @synthesize preShowType=_preShowType;
...
- (void).cxx_destruct;
- (void)voiceSearchTimeout:(id)arg1;
- (void)voiceSearchBarResume:(id)arg1;
- (void)voiceSearchBarWillCancel:(id)arg1;
- (void)voiceSearchBar:(id)arg1 volumeDidChange:(unsigned long long)arg2;
- (void)voiceSearchBarDidCancel:(id)arg1;
- (void)voiceSearchBarDidEnd:(id)arg1 result:(id)arg2;
- (void)voiceSearchBarDidError:(id)arg1 error:(id)arg2;
- (void)voiceSearchBarDidSearch:(id)arg1;
- (void)voiceSearchBarDidRecord:(id)arg1;
- (void)loadVoiceHotWord;

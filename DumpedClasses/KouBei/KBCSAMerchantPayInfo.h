...
@class KBCSADetailPayExt, NSDate, NSDictionary, NSString;

@interface KBCSAMerchantPayInfo : KBCSAToString
{
    _Bool _checkFlag;
    _Bool _countDown;
    _Bool _autoObtain;
    ...
    KBCSADetailPayExt *_customCouponExt;
    NSDictionary *_extMap;
}

+ (Class)extMapElementClass;
@property(retain, nonatomic) NSDictionary *extMap; // @synthesize extMap=_extMap;
@property(retain, nonatomic) KBCSADetailPayExt *customCouponExt; // @synthesize customCouponExt=_customCouponExt;

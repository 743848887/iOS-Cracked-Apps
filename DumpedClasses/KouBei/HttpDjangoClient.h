...
@class DjangoTokenManager, NSMutableDictionary, NSOperationQueue, NSString;
...
- (void)generalWaterMarkWithId:(id)arg1 sourceId:(id)arg2 zoom:(id)arg3 position:(unsigned long long)arg4 transparency:(unsigned long long)arg5 width:(unsigned long long)arg6 height:(unsigned long long)arg7 xgap:(unsigned long long)arg8 ygap:(unsigned long long)arg9 pScale:(unsigned long long)arg10 taskRecord:(id)arg11 progress:(CDUnknownBlockType)arg12 success:(CDUnknownBlockType)arg13 fail:(CDUnknownBlockType)arg14;
- (void)getWaterMarkWithId:(id)arg1 sourceId:(id)arg2 zoom:(id)arg3 position:(unsigned long long)arg4 transparency:(unsigned long long)arg5 width:(unsigned long long)arg6 height:(unsigned long long)arg7 xgap:(unsigned long long)arg8 ygap:(unsigned long long)arg9 pScale:(unsigned long long)arg10 taskRecord:(id)arg11 progress:(CDUnknownBlockType)arg12 success:(CDUnknownBlockType)arg13 fail:(CDUnknownBlockType)arg14;
...
- (void)getThumbnailWithId:(id)arg1 zoom:(id)arg2 zoom2:(id)arg3 taskRecord:(id)arg4 source:(id)arg5 progress:(CDUnknownBlockType)arg6 success:(CDUnknownBlockType)arg7 fail:(CDUnknownBlockType)arg8;

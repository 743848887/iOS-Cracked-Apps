...
+ (_Bool)isAliPayNativeURL:(id)arg1;
...
+ (_Bool)redirect2AlipayH5:(id)arg1;
+ (id)convertUrl:(id)arg1 withAppId:(id)arg2;
+ (void)openUrl:(id)arg1;
+ (void)openUrlInAlipayApp:(id)arg1 goAlipayTip:(id)arg2;
+ (void)openUrlInAlipayApp:(id)arg1;

...
@property(readonly, nonatomic) __weak PTHTweetbotRateLimit *rateLimit;
- (void)loadGap:(CDUnknownBlockType)arg1;
@property(readonly, nonatomic) __weak NSMutableDictionary *gapQueryDictionary;
...
@property(readonly, nonatomic) __weak NSMutableDictionary *olderQueryDictionary;
...
@property(readonly, nonatomic) __weak NSMutableDictionary *refreshQueryDictionary;
...
@property(readonly, nonatomic) __weak NSMutableDictionary *queryDictionary;

...
#import "PTHTweetbotEntityTextLabelDelegate-Protocol.h"

@class NSLayoutConstraint, NSMutableArray, NSString, PTHKeyValueObserver, PTHTweetbotAvatarView, PTHTweetbotDirectMessage, PTHTweetbotDirectMessagesController, PTHTweetbotEntity, PTHTweetbotEntityTextLabel, PTHTweetbotPostDraft, UIImageView, UILabel, _PTHMaskedImageView;

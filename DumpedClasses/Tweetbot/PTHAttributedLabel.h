...
- (id)attributeNamed:(id)arg1 forEvent:(id)arg2 hitFrame:(struct CGRect *)arg3 longestEffectiveRange:(struct _NSRange *)arg4;
- (id)attributeNamed:(id)arg1 hitRect:(struct CGRect)arg2 contentRect:(struct CGRect)arg3 hitFrame:(struct CGRect *)arg4 longestEffectiveRange:(struct _NSRange *)arg5;
- (id)attributesAtLocation:(struct CGPoint)arg1 contentRect:(struct CGRect)arg2 hitFrame:(struct CGRect *)arg3 longestEffectiveRange:(struct _NSRange *)arg4;

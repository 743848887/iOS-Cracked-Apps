...
@class NSMutableArray, NSMutableDictionary, NSString, PTHHelpPointer, PTHReachability, PTHTweetbotAccount, PTHTweetbotAccountPhoneTabPicker, PTHTweetbotAccountQuickPickerController, PTHTweetbotCursorController, PTHTweetbotDirectMessageThreadsController, PTHTweetbotDirectMessagesLoginController, PTHTweetbotNavigationController, PTHTweetbotSyncService, UIBarButtonItem, UIViewController;
...
@property(readonly, nonatomic) __weak PTHTweetbotAccount *account; // @synthesize account=_account;
- (void).cxx_destruct;
- (void)dealloc;
...
@property(readonly, retain, nonatomic) PTHTweetbotNavigationController *selectedNavigationController;

...
@class NSMutableArray, NSString, PTHShapeView, PTHTweetbotAccount, PTHTweetbotAvatarView, UIDynamicAnimator, UIDynamicItemBehavior, UIScrollView, UISnapBehavior, UIView;

...
@class NSData, NSDictionary, NSError, NSHTTPURLResponse, NSMutableData, NSMutableDictionary, NSString, NSURL, NSURLCredential, NSURLRequest, NSURLSession, NSURLSessionTask, PTHURLRequestMimePostData;
...
@property(readonly, nonatomic) __weak NSURL *urlWithParams;
@property(readonly, nonatomic) NSString *requestMethodString;
@property(readonly, nonatomic) __weak NSMutableDictionary *debugDictionary;
- (id)init;

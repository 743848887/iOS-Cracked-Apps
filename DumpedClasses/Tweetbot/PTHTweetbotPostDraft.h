...
@property(readonly, nonatomic) long long quoteStatusTID; // @synthesize quoteStatusTID=_quoteStatusTID;
...
@property(readonly, nonatomic) __weak NSString *postText;
- (void)appendText:(id)arg1;
- (void)cancelPlaceSearch;
@property(readonly, nonatomic) __weak NSString *locationTitle;

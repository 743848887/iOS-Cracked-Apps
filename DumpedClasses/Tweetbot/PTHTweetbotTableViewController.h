...
#import "PTHTweetbotSearchTableViewDelegate-Protocol.h"
...
@property(readonly, nonatomic) __weak NSString *toolbarTitle;
@property(readonly, nonatomic) __weak NSString *nothingFoundTitle;
@property(readonly, nonatomic) __weak NSString *itemsTitle;
@property(readonly, nonatomic) __weak NSString *itemTitle;
@property(readonly, nonatomic) unsigned long long itemDisplayCount;
@property(readonly, nonatomic) __weak NSString *searchTitle;
- (Class)cellClass;
- (void)reloadData;

...
@property(readonly, nonatomic) __weak PTHTweetbotCursor *currentUserListMembershipsCursor;
@property(readonly, nonatomic) __weak PTHTweetbotCursor *listMembershipsCursor;
@property(readonly, nonatomic) __weak PTHTweetbotListsCursor *listsCursor;
@property(readonly, nonatomic) __weak PTHTweetbotCursor *followersCursor;
@property(readonly, nonatomic) __weak PTHTweetbotCursor *followingCursor;
@property(readonly, nonatomic) __weak PTHTweetbotCursor *favoritesCursor;
@property(readonly, nonatomic) __weak PTHTweetbotCursor *mentionsCursor;
@property(readonly, nonatomic) __weak PTHTweetbotCursor *userTimelineCursor;
@property(readonly, nonatomic) __weak NSString *formattedName;
@property(readonly, nonatomic) __weak NSString *displayName;
- (void)addUserQueryKey:(id)arg1;
@property(readonly, nonatomic) __weak NSString *decodedUserDescription;
@property(readonly, nonatomic) __weak NSAttributedString *attributedUserDescription;

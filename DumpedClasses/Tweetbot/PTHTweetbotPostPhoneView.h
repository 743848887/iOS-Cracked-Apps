...
@class NSArray, NSLayoutConstraint, NSString, PTHTweetbotAvatarView, PTHTweetbotPostDraft, PTHTweetbotPostDraftIndicatorView, PTHTweetbotPostGeoView, PTHTweetbotPostMediaView, PTHTweetbotPostThreadView, PTHTweetbotPostToolbarView, UIScrollView, UITextView, _PTHTweetbotPostPhoneScrollView;
